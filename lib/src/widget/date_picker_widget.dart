...
class _DatePickerWidgetState extends State<DatePickerWidget> {
  ...
  Widget _renderPickerView(BuildContext context) {
    ...
    if (widget.pickerTheme.title != null || widget.pickerTheme.showTitle) {
      ...
      return Column(mainAxisSize:MainAxisSize.min,children: <Widget>[ datePickerWidget,titleWidget,]);
    }
  ...
  Widget _renderDatePickerItemComponent(int value, String format,) {
    return Container(
      ...
      child:_renderText(format,value)
    );
  }
  ...
  _renderText(String format, int value) {
    if( format.contains('y')){
      return Text(
        DateTimeFormatter.formatDateTime(value, format, widget.locale),
        style:
        value==_currYear? widget.pickerTheme.itemTextStyle:DATETIME_PICKER_ITEM_TEXT_STYLE,
      );
    }else    if( format.contains('M')){
      return Text(
        DateTimeFormatter.formatDateTime(value, format, widget.locale),
        style:
        value==_currMonth? widget.pickerTheme.itemTextStyle:DATETIME_PICKER_ITEM_TEXT_STYLE,
      );
    }else    if( format.contains('d')){
      return Text(
        DateTimeFormatter.formatDateTime(value, format, widget.locale),
        style:
        value==_currDay? widget.pickerTheme.itemTextStyle:DATETIME_PICKER_ITEM_TEXT_STYLE,
      );
    }
  }
}
